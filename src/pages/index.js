  ...
  return (
   <>
      ...
      <div className="absolute overflow-x-hidden bg-white" id="pages">
        <section id="home" className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center pl-8 md:pl-3"
          // data-sal="slide-up"
          ...
          <section id="about" className="min-h-screen text-center text-white bg-black">
            <h1>This is About section</h1>
            <p>Industrial Workshop is an annual event held by Himpunan Mahasiswa Teknik Industri Universitas</p>
            <br/>
            <p>
              This year is the 10ᵗʰ year of Industrial Workshop. The history of this event is started with Ernographic
          ...
          <section id="workshop" className="min-h-screen">
          <h1>This is Workshop section</h1>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, repellendus. Totam nihil similique a repellat minus dolor amet quasi. Corporis nulla quaerat iste, sed quasi ab dolorem maxime minima animi.
          </section>
          <section id="wpc" className="min-h-screen text-white bg-black">
