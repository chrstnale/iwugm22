...
export const DaftarTestimoni = [
    {
        photo: <StaticImage src='../images/speaker3.webp' alt='Pramudono Kumoro' placeholder='none'/>,
    ...
    {
        photo: <StaticImage src='../images/wpc1.webp' alt='Jessica' placeholder='none'/>,
        name: 'Jessica',
        jobTitle: 'Happy Team',
    ...
    {
        photo: <StaticImage src='../images/speaker2.webp' alt='Ryan Maurice Tallulah' placeholder='none'/>,
    ...
    {
        photo: <StaticImage src='../images/wpc2.webp' alt='Fidei' placeholder='none'/>,
        name: 'Fidei',
        jobTitle: 'Malatax Team',
        eventTitle: '1st Runner Up WPC IW 2021',
        testimony: <p>"Unlocking my milestone was done by joining IW UGM. Due to the pandemic, we all do everything from home, so my team called Malatax, and I have an immense desire to enter a competition, especially at the international level. When we see IW UGM, there’s so much curiosity to join this competition. <br/><br/>Then, we faced many challenges and surprising moments here at IW UGM, such as bridging the gap between digitalization through technology to help small middle businesses in Indonesia, real company study case provided by Telkomsel IoT to solve the lack of knowledge about IoT innovation and the Telkomsel IoT manufacturer issues in Indonesia. All of those experiences are <b className='text-lg'>really recommended to those interested in solving case studies</b> by giving unique ideas through creation. For me, “Better to try than never,” lastly join IW UGM to <b className='text-lg'>feel and test your solving problem skill</b> as a college student. Thank you!"</p>
    },
    {
        photo: <StaticImage src='../images/speaker1.webp' alt='David Christian' placeholder='none'/>,
    ...
    {
        photo: <StaticImage src='../images/wpc3.webp' alt='Valen' placeholder='none'/>,
        name: 'Valen',
